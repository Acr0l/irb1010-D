...
while(True): 
   ...
   #Se repite el proceso, ahora para encontar los arcos
    ...
    #Hacer print si tenemos control de la pelota
    margen_error_distancia = 5
    if angle1 < 10 and angle1 > -10 and dist_real < margen_error_distancia:
        print("CONTROL DE LA PELOTA")
    #Actualizar PID
